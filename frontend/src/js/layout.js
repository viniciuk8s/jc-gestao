...
(function () {
  ...
  <header class="mobile-topbar">
    ...
    <div class="mobile-logo">
      <img width="35" src="src/img/icone-laranja.png" alt="">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <a href="fluxo-caixa.html" class="nav-item" data-nav="fluxo" onclick="setActive(this)">
        <div class="nav-icon"><i class="bi bi-repeat"></i></div>
      ...
      <a href="relatorios.html" class="nav-item" data-nav="relatorios" onclick="setActive(this)">
        <div class="nav-icon"><i class="bi bi-layers"></i></div>
      ...
      <a href="projetos.html" class="nav-item" data-nav="projetos" onclick="setActive(this)">
        <div class="nav-icon"><i class="bi bi-lightning-charge"></i></div>
  ...
  // Sem depender do Storage/RLS: reduz a imagem no canvas (quadrada, <=192px)
  // e devolve um dataURL JPEG leve, guardado depois em user_metadata.avatar_url.
  function fileParaAvatar(file, size) {
    size = size || 192;
  ...
  window.jcPerfil = async function () {
    ...
    box.querySelector('#jcui-perfil-save').addEventListener('click', async function () {
      ...
      try {
        ...
        if (pendingFile) {
          msg.style.color = ''; msg.textContent = 'Processando imagem\u2026';
          dados.avatar_url = await fileParaAvatar(pendingFile, 192);
        }
